using SimpleWeightedGraphs, Graphs, JLD2
import GraphPlot
...
@everywhere begin
    include("./Pong/PongAgent_Functions_allo.jl");
    ...
    function run_model(n)
        ...
        global sens_degrees = collect(5:10:495)
...
save_object("meanHits_all_allo.jld2", meanHits_all)
save_object("first100_all_allo.jld2", first100_all)
save_object("last100_all_allo.jld2", last100_all)
save_object("hits_all_allo.jld2", hits_all)
